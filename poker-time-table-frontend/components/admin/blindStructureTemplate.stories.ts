...
const Template = (args) => ({
  ...
  template: '<v-app><AdminBlindStructureTemplate :structure=args.blindStructure /></v-app>'
})

export const BlindStructureTemplate = Template.bind({})
BlindStructureTemplate.args = {
  blindStructure
}
